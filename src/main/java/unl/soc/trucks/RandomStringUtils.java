...
public abstract class RandomStringUtils {
	 ...
	 * <code>' '</code> and <code>'z'</code>, the ASCII printable characters, will
	 * be used, unless letters and numbers are both <code>false</code>, in which
	 * case, start and end are set to <code>0</code> and
